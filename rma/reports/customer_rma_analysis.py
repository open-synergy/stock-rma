...
class CustomerRmaAnalysis(models.Model):
    _name = "rma.customer_rma_analysis"
    _description = "Customer RMA Analysis Analysis"
    _auto = False
    ...
    def _select(self):
        ...
        SELECT
            ...
            SUM(a.qty_to_supplier_rma) AS qty_to_supplier_rma,
            SUM(a.qty_in_supplier_rma) AS qty_in_supplier_rma
        """
        return select_str
